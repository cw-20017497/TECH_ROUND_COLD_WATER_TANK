...
void R_Config_ADC_Create(void)
{
    ...
    PMCA10 |= 0x01U;
    PM10 |= 0x01U;
    ADM0 = _00_AD_OPERMODE_SELECT | _28_AD_CONVERSION_CLOCK_1 | _00_AD_TIME_MODE_NORMAL_1;
...
MD_STATUS R_Config_ADC_Set_ADChannel(e_ad_channel_t channel)
{
    ...
    if (((channel > ADCHANNEL14) && (channel < ADCHANNEL16)) || ((channel > ADCHANNEL20) && (channel != ADTSCAP)
