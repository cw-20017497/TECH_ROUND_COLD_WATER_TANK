...
{
    Diagnosis24v.StepInit = STEP_24V_INIT_START;
    Diagnosis24v.StepValve = STEP_24V_VALVE_NOS_VALVE;
    Diagnosis24v.StepIceDoor = STEP_24V_ICE_DOOR_1;
    Diagnosis24v.StepFlowValve = STEP_24V_FLOW_VALVE_1;
    Diagnosis24v.StepSwingBar = STEP_24V_SWING_BAR;
...
static DiagnosisEventList_T    DiagnosisPart24VEventList[] =
{
