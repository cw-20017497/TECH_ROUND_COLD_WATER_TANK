...
{
    DiagnosisFeedback.StepInit = STEP_FEEDBACK_INIT_START;
    DiagnosisFeedback.StepUv = STEP_FEEDBACK_UV_WATER_OUT;
    DiagnosisFeedback.StepDrainPump = STEP_FEEDBACK_DRAIN_PUMP;
    DiagnosisFeedback.StepFan = STEP_FEEDBACK_FAN;
    DiagnosisFeedback.StepHeater = STEP_FEEDBACK_HEATER_1;
...
static DiagnosisEventList_T    DiagnosisPartFeedbackEventList[] =
{
