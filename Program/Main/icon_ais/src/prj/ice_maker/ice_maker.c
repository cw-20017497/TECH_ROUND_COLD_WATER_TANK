...
{
    Init.Step = STEP_INIT_TRAY_MOVE; 
}

static void InitDoPreheat(void)
{
    Preheat.Step = STEP_PREHEAT_CHECK; 
}

static void InitDoReady(void)
{
    Ready.Step = STEP_READY_CHECK_CONDITION;
}

static void InitDoIcing(void)
{
    Icing.Step = STEP_ICING_CHECK_COMP;
}

static void InitDoDeIcing(void)
{
    DeIcing.Step = STEP_DEICING_TRAY_MOVE;
}

static void InitDoDummyDeIcing(void)
{
    DummyDeIcing.Step = STEP_DUMMY_DEICING_GAS_SWITCH;
}
static void InitDoTrayDeIcing(void)
{
    TrayDeIcing.Step = STEP_TRAY_DEICING_INIT;
}
