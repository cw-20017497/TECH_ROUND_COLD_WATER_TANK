...
#define	WIFI_BUZZER_WiFi_OFF        0x0A  // 블루투스 패어링 해제음(동띵)
#define	WIFI_BUZZER_BLE_OFF         0x0B  // 블루투스 패어링 해제음(동띵)
#define WIFI_BUZZER_BLE_CONNECT     0x0C
#define WIFI_BUZZER_BLE_CERT        0x49 // (선택음 "띵") / 블루투스 점유인증 활성화 상태 / 제품인증을 진행 중입니다. 앱에서 가이드하는 버튼을 눌러주세요. (웨스턴 추가)
#define WIFI_BUZZER_SMART_CHECK_START       0x50 // (설정음 "띵동 ↗") / 스마트 진단을 시작합니다. 진행 중에는 제품을 사용할 수 없으니 잠시만 기다려 주세요. (웨스턴 추가)
#define WIFI_BUZZER_SMART_CHECK_OK          0x51 // (설정음 "띵동 ↗") / 스마트 진단이 완료 되어 제품을 사용하실 수 있습니다. (웨스턴 추가)
#define WIFI_BUZZER_SMART_CHECK_ERROR       0x52 // 불가음 (에러음 "띵깡띵깡") / 스마트 진단이 완료 되었습니다. (웨스턴 추가)
