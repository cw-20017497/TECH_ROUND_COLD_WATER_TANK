...
/*==============================================================================
 Timer Decrease
 ==============================================================================*/
#define	TDEC_1ms_WiFi()			{	/*	1ms A¢¬AI¢¬O ¡Æ¡§¡íe			*/	\
								}
#define	TDEC_10ms_WiFi()			{	/*	10ms A¢¬AI¢¬O ¡Æ¡§¡íe		*/	\
								}
#define	TDEC_100ms_WiFi()		{	/*	100ms A¢¬AI¢¬O ¡Æ¡§¡íe		*/	\
								}
#define	TDEC_1s_WiFi()			{	/*	1s A¢¬AI¢¬O ¡Æ¡§¡íe			*/	\
								}
#define	TDEC_10s_WiFi()			{	/*	10s A¢¬AI¢¬O ¡Æ¡§¡íe			*/	\
								}
#define	TDEC_1min_WiFi()		{	/*	1min A¢¬AI¢¬O ¡Æ¡§¡íe		*/	\
								}
#define	TDEC_10min_WiFi()		{	/*	10min A¢¬AI¢¬O ¡Æ¡§¡íe		*/	\
								}
#define	TDEC_1h_WiFi()			{	/*	1h A¢¬AI¢¬O ¡Æ¡§¡íe			*/	\
