...
#define UNUSED_BLE_A1011_RX       // BLE DATA(A1011) ¨ùo¨öAA©ø¢¬¢ç ©öI¡íc¢¯e
/***** Define *****************************************************************/
#ifndef TRUE
#define TRUE 1
#endif
...
#define W_COUNT_WIFI_POWER    100 // 100ms*100 @|?x @N0! HD >HA$H-

#define CONCAT(a, b) a##b

#define TURN_ON_WIFI_POW()  do{ PIN_WRITE(P_WIFI_ON) = ON; }while(0)
#define TURN_OFF_WIFI_POW() do{ PIN_WRITE(P_WIFI_ON) = OFF; }while(0)
#define TURN_ON_WIFI_RST()  do{ PIN_WRITE(P_WIFI_RSTN) = ON; }while(0)
#define TURN_OFF_WIFI_RST() do{ PIN_WRITE(P_WIFI_RSTN) = OFF; }while(0)
...
#ifndef _MEMSET_
#define _MEMSET_    memset    //memset_f( void __far *a, int b, size_t n );
#endif

#ifndef _MEMCPY_
#define _MEMCPY_    memcpy    //memcpy_f( void __far *a, const void __far *b, size_t n );
#endif

#ifndef _MEMMOVE_
#define _MEMMOVE_   memmove   //memmove_f( void __far *a, const void __far *b, size_t n );
#endif

#ifndef _MEMCMP_
#define _MEMCMP_    memcmp    //memcmp_f( const void __far *a, const void __far *b, size_t n );
#endif

#ifndef _STRCPY_
#define _STRCPY_    strcpy    //strcpy_f( char __far *a, const char __far *b );
#endif

#ifndef _STRNCPY_
#define _STRNCPY_   strncpy   //strncpy_f( char __far *a, const char __far *b, size_t n );
#endif

#ifndef _STRCMP_
#define _STRCMP_    strcmp    //strcmp_f( const char __far *a, const char __far *b );
#endif

#ifndef _STRNCMP_
#define _STRNCMP_   strncmp   //strncmp_f( const char __far *a, const char __far *b, size_t n );
#endif

#ifndef _STRLEN_
#define _STRLEN_    strlen    //strlen_f( const char __far *a );
#endif
...
#ifndef _ATOI_
#define _ATOI_      atoi      //atoi_f( const char __far *a );
#endif
...
I8 WIFI_HEX2ASCII ( U8 mu8HexData );
U8 WIFI_ASCII2HEX ( U8 mu8AsciiData );
//U16 far_sprintf_s ( I8* pBuf, U16 mLen, I8* pData );
U16 far_sprintf_s ( I8* pBuf, U16 mLen, const I8* pData );
