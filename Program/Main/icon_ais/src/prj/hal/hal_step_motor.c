...
/* 2.5ms */
#pragma interrupt StepMotorTimerInterrupt(vect=INTTM01)
...
void HAL_InitStepMotor(void)
{
    ...
    R_Config_TAU0_1_Start();   // Start Timer-01
}
...
static void     HAL_ControlGasValveMotor( U8 mode )
{
    ...
    {
        case 0:
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_1)  = 0;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_2)  = 0;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_3)  = 0;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_4)  = 0;
            break;
        case 1:
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_1)  = 1;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_2)  = 0;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_3)  = 0;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_4)  = 1;
            break;
        case 2:
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_1)  = 0;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_2)  = 0;
        ...
        case 3:
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_1)  = 0;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_2)  = 0;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_3)  = 1;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_4)  = 1;
            break;
        case 4:
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_1)  = 0;
        ...
        case 5:
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_1)  = 0;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_2)  = 1;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_3)  = 1;
            PIN_WRITE(P_STEP_MOTOR_GAS_SW_4)  = 0;
            break;
        case 6:
...
static void     HAL_ControlIceDoorMotor( U8 mode )
{
    ...
    {
        case 0:
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_1)  = 0;
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_2)  = 0;
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_3)  = 0;
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_4)  = 0;
            break;
        case 1:
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_1)  = 0;
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_2)  = 0;
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_3)  = 1;
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_4)  = 1;
            break;
        case 2:
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_1)  = 1;
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_2)  = 0;
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_3)  = 0;
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_4)  = 1;
            break;
        case 3:
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_1)  = 1;
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_2)  = 1;
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_3)  = 0;
            PIN_WRITE(P_STEP_MOTOR_ICE_DOOR_4)  = 0;
            break;
        case 4:
...
static void     HAL_ControlFlowValve( U8 mode )
{
    ...
    {
        case 0:
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_1)  = 0;
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_2)  = 0;
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_3)  = 0;
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_4)  = 0;
            break;
        case 1:
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_1)  = 0;
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_2)  = 0;
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_3)  = 1;
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_4)  = 1;
            break;
        case 2:
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_1)  = 1;
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_2)  = 0;
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_3)  = 0;
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_4)  = 1;
            break;
        case 3:
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_1)  = 1;
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_2)  = 1;
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_3)  = 0;
            PIN_WRITE(P_STEP_MOTOR_FLOW_VALVE_4)  = 0;
            break;
        case 4:
...
static void __near StepMotorTimerInterrupt(void)
{
