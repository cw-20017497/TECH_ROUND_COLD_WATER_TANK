...
static void Evt_10sec_Handler( void )
{
    StartTimer( TIMER_ID_10SEC, TIMER_SEC(10) );
...
static void Evt_40sec_Handler( void )
{
    StartTimer( TIMER_ID_40SEC, TIMER_SEC(40) );
...
static void Evt_1min_Handler( void )
{
    StartTimer( TIMER_ID_1MIN, TIMER_SEC(60) );
...
static void Evt_Comp_Handler( void )
{
    StartTimer( TIMER_ID_COMP, TIMER_SEC(2) );
...
static void Evt_Test_8585_Handler( void )
{
    ...
    {
        the_8585_step = 0;
        StartTimer( TIMER_ID_TEST_8585, TIMER_SEC( 1 ) );
        return ;
    }
    ...
    switch( the_8585_step )
    {
        ...
        case 0:
            if( GetWaterOut() == TRUE )
            {
                StartTimer( TIMER_ID_TEST_8585, TIMER_SEC( 10 ) );
                break;
            }
            ...
            StartWaterOut();
            StartTimer( TIMER_ID_TEST_8585, TIMER_SEC( 3600U ) );
            the_8585_step++;
            break;
        ...
        case 2:
            StartTimer( TIMER_ID_TEST_8585, TIMER_SEC( 0 ) );
            the_8585_step = 0;
            break;
...
static void Evt_Test_8585_2_Handler( void )
{
    ...
    {
        the_8585_step_2 = 0;
        StartTimer( TIMER_ID_TEST_8585_2, TIMER_SEC( 1 ) );
        return ;
    }
    ...
    {
        case 0:
            StartTimer( TIMER_ID_TEST_8585_2, TIMER_SEC( 2100U ) );   //35
            the_8585_step_2++;
            break;
        ...
        case 1:
            if( GetWaterOut() == TRUE )
            {
                StartTimer( TIMER_ID_TEST_8585_2, TIMER_SEC( 10 ) );
                break;
            }
            ...
            StartWaterOut();
            StartTimer( TIMER_ID_TEST_8585_2, TIMER_SEC( TEST_WATER_OUT_TIME_2 ) );
            the_8585_step_2++;
            break;
...
static void Evt_Test_8585_Handler( void )
{
    ...
    switch( the_8585_step )
    {
        case 0:
            ...
            if( GetWaterOut() == TRUE )
            {
                StartTimer( TIMER_ID_TEST_8585, TIMER_SEC( 3 ) );
                break;
            }
...
static void Evt_Test_8585_Ice_Handler( void )
{
    switch( the_8585_step_ice )
    {
        ...
        case 0:
            ...
            {
                StartTimer( TIMER_ID_TEST_8585_ICE, TIMER_SEC(1800UL) );
                the_8585_step_ice++;
            }
            else
            {
                StartTimer( TIMER_ID_TEST_8585_ICE, TIMER_SEC(1) );
            }
            break;
        ...
        case 2:
            CloseIceDoor();
            StartTimer( TIMER_ID_TEST_8585_ICE, TIMER_SEC(60) );
            the_8585_step_ice = 0;
            break;

        default:
            StartTimer( TIMER_ID_TEST_8585_ICE, TIMER_SEC(0) );
            the_8585_step_ice = 0;
            break;
    }
}
...
static void Evt_Test_GasSwitch_Handler( void )
{
            ...
            || IsError( ERR_COMP_COMM ) == TRUE )
    {
        ...
        StartTimer( TIMER_ID_TEST_100MS, TIMER_SEC(10) );
        return ;
    }
