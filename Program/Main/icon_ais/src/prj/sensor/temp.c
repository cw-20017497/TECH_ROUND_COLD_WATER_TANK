#include "hal_adc.h"
#include "temp.h"
#include "temp_table_ambient.h"
#include "temp_table_ice_tray_in.h"
...
void ProcessTemp(void)
{
    ...
    gAdcTempCold = HAL_GetAdcValue( ANI_TEMP_COLD_WATER );
    gAdcTempRoom = HAL_GetAdcValue( ANI_TEMP_ROOM_WATER );
    gAdcTempAmbi = HAL_GetAdcValue( ANI_TEMP_AMBIENT );
    gAdcTempEva1 = HAL_GetAdcValue( ANI_TEMP_EVA_1 );
