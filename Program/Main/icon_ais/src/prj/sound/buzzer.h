...
#if (TDR_USE==0)
// none
#define	SoundStart()		do{ NOP(); }while(0)
#define	SoundStop()			do{ NOP(); }while(0)
#elif (TDR_USE==1)
#define	SoundStart()		do{R_Config_TAU0_0_Start();}while(0)
#define	SoundStop()			do{R_Config_TAU0_0_Stop(); TO0 &= ~_0001_TAU_CH0_OUTPUT_VALUE_1;}while(0)
#elif (TDR_USE==2)
#define	SoundStart()		do{R_Config_TAU1_1_Start();}while(0)
#define	SoundStop()			do{R_Config_TAU1_1_Stop(); TO0 &= ~_0002_TAU_CH1_OUTPUT_VALUE_1;}while(0)
#elif (TDR_USE==3)
#define	SoundStart()		do{R_Config_TAU0_2_Start();}while(0)
#define	SoundStop()			do{R_Config_TAU0_2_Stop(); TO0 &= ~_0004_TAU_CH2_OUTPUT_VALUE_1;}while(0)
#elif (TDR_USE==4)
#define	SoundStart()		do{R_Config_TAU0_3_Start();}while(0)
#define	SoundStop()			do{R_Config_TAU0_3_Stop(); TO0 &= ~_0008_TAU_CH3_OUTPUT_VALUE_1;}while(0)
#elif (TDR_USE==5)
#define	SoundStart()		do{R_Config_TAU0_4_Start();}while(0)
#define	SoundStop()			do{R_Config_TAU0_4_Stop(); TO0 &= ~_0010_TAU_CH4_OUTPUT_VALUE_1;}while(0)
#elif (TDR_USE==6)
#define	SoundStart()		do{R_Config_TAU0_5_Start();}while(0)
#define	SoundStop()			do{R_Config_TAU0_5_Stop(); TO0 &= ~_0020_TAU_CH5_OUTPUT_VALUE_1;}while(0)
#elif (TDR_USE==7)
#define	SoundStart()		do{R_Config_TAU0_6_Start();}while(0)
#define	SoundStop()			do{R_Config_TAU0_6_Stop(); TO0 &= ~_0040_TAU_CH6_OUTPUT_VALUE_1;}while(0)
#else // (TDR_USE==7)
#define	SoundStart()		do{R_Config_TAU0_7_Start();}while(0)
#define	SoundStop()			do{R_Config_TAU0_7_Stop(); TO0 &= ~_0080_TAU_CH7_OUTPUT_VALUE_1;}while(0)
#endif
...
#define TURN_ON_BUZZER_ONOFF()      do{ }while(0)
#define TURN_OFF_BUZZER_ONOFF()     do{ } while(0)
