            ...
            && IsSetKeyEventFlag( KEY_EVENT_POP ) == TRUE )
    {
        ...
        for( i = 0; i < mu8Size ; i++ )
        {
            if( (pList+i)->Key == mu32KeyPopVal )
            {
                ...
                {
                    mSound = (SoundId_T)(pList+i)->actionEvent[KEY_ACTION_POP]();
                    Sound( mSound );
                    return TRUE;
                }
            }
    ...
    for( i = 0; i < mu8Size ; i++ )
    {
        if( (pList+i)->Key == mu32KeyVal )
        {
            if( IsSetKeyEventFlag( KEY_EVENT_PUSHED_SHORT ) == TRUE )
            {
                ...
                {
                    mSound = (SoundId_T)(pList+i)->actionEvent[KEY_ACTION_SHORT]();
                    Sound( mSound );
                    return TRUE;
                }
                break;
            ...
            else if( IsSetKeyEventFlag( KEY_EVENT_PUSHED_LONG_5S ) == TRUE )
            {
                ...
                {
                    mSound = (SoundId_T)(pList+i)->actionEvent[KEY_ACTION_5_SEC]();
                    Sound( mSound );
                    return TRUE;
                }
                break;
            ...
            else if( IsSetKeyEventFlag( KEY_EVENT_PUSHED_LONG_3S ) == TRUE )
            {
                ...
                {
                    mSound = (SoundId_T)(pList+i)->actionEvent[ KEY_ACTION_3_SEC ]();
                    Sound( mSound );
                    return TRUE;
                }
                break;
            ...
            else if( IsSetKeyEventFlag( KEY_EVENT_PUSHED_LONG_2S ) == TRUE )
            {
                ...
                {
                    mSound = (SoundId_T)(pList+i)->actionEvent[ KEY_ACTION_2_SEC ]();
                    Sound( mSound );
                    return TRUE;
                }
                break;
            ...
            else if( IsSetKeyEventFlag( KEY_EVENT_PUSHED_LONG_1S ) == TRUE )
            {
                ...
                {
                    mSound = (SoundId_T)(pList+i)->actionEvent[ KEY_ACTION_1_SEC ]();
                    Sound( mSound );
                    return TRUE;
                }
                break;
