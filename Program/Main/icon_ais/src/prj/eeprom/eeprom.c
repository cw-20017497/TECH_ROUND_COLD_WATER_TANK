...
static U8 ReadBlockId(EepromBlock_T mu8BlockId, U8 *pBuf)
{
    U8 mu8Ret;
...
static U8 WriteBlock1(EepromBlock_T mBlockId)
{
    ...
    Eep.WriteData[ 0 ] = (U8)GetFlushSetupInit(); 
    Eep.WriteData[ 1 ] = (U8)GetFlushStatus();
...
static U8 ReadBlock1(EepromBlock_T mBlockId)
{
    ...
    /* FLUSHING - 최초 설치 */
    SetFlushSetupInit((FlushStatus_T)Eep.ReadData[0] );      
    
    /* FLUSHING - 필터 교체 */
    SetFlushStatus( (FlushStatus_T)Eep.ReadData[1] );      // FLUSHING STATUS
...
static U8 WriteBlock2(EepromBlock_T mBlockId)
{
    ...
    Eep.WriteData[ 0 ] = (U8)mMemento.Error;
    ...
    Eep.WriteData[ 5 ] = (U8)mMemento.Error;
...
static U8 ReadBlock2(EepromBlock_T mBlockId)
{
    ...
    // Memento 0 
    mMemento.Error = (ErrorId_T)Eep.ReadData[0];
    ...
    // Memento 1
    mMemento.Error = (ErrorId_T)Eep.ReadData[5];
...
extern SWifiStatus_T WiFi;
static U8 WriteBlock8(EepromBlock_T mBlockId)
{
    U16 mu16CheckSum = 0U;


    Eep.WriteData[ 0 ] = WiFi.mUonOff;
    Eep.WriteData[ 1 ] = WiFi.mUfirstParing;
    Eep.WriteData[ 2 ] = WiFi.mUfotaModule;
    Eep.WriteData[ 3 ] = WiFi.mUfotaMain;
    Eep.WriteData[ 4 ]  = 0;
    Eep.WriteData[ 5 ]  = 0;
    Eep.WriteData[ 6 ]  = 0;
    Eep.WriteData[ 7 ]  = 0;
...
static U8 ReadBlock8(EepromBlock_T mBlockId)
{
    ...
    // Load Data
    WiFi.mUonOff       = Eep.ReadData[0];
    WiFi.mUfirstParing = Eep.ReadData[1];
    WiFi.mUfotaModule  = Eep.ReadData[2];
    WiFi.mUfotaMain    = Eep.ReadData[3];
